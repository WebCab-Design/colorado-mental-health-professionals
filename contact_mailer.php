<?php 
	...
	if(isset($_POST['contact_first_name'])) {
		...
		$email_to = "
			...
			cplush@springsrecoveryconnection.org,
			bburns@peaksrecovery.com
		";
		$email_subject = "New Contact Form submission from Springs Recovery Rally event page";
		$email_from = "NoReply@springsrecoveryrally.com";
		...
		if(
			...
			//Sucess output. Change as requred.
			echo('<p>Thank you for contacting us '.$contact_first_name_submitted.' '.$contact_last_name_submitted.'. Your form submission has submitted successfully.'); 
